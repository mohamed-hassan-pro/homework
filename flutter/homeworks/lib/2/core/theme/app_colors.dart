...
class AppColors {
  ...
  static const Color bannerBackground = Color(
    0xFF8155BA,
  ); // البنفسجي الفاتح للبانر
  static const Color bannerButton = Color(
    0xFF5E35B1,
  ); // البنفسجي الغامق لزر البانر
